...
Arthur = Personnage("Arthur",3,10,0,0,"Mage",0,0,0,0,0,0,0)
...
Boule_de_feu = Sort("Boule de feu", 50, "C'est une boule de feu", 10, 0, Brulure)
Glace = Sort("Glace", 50, "Non ce n'est pas celle que tu manges l'été", 10, 0, Congele)
Mage = Classe("Mage",[Boule_de_feu.nom])
